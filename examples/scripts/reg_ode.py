...
from diffrax import Heun, NoAdjoint, SaveAt

from rfp import MLP, Trainer, feature_map_loss, neuralODE, sample2
...
def main(argv):
    ...
    feature_map = neuralODE(
        mlp, solver, FLAGS.t1, saveat=SaveAt(dense=True), adjoint=NoAdjoint()
    )
    ...
    fig, (ax0, ax1, ax2) = plt.subplots(
        nrows=1, ncols=3, dpi=300, tight_layout=True, figsize=(12, 6)
    )
